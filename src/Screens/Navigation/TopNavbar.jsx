...
const TopNavbar = (props) => {
  ...
  return (
    <header className="fixed w-full">
      <nav
        className="flex  items-center justify-between p-4 px- lg:px-8"
        aria-label="Global"
      >
        ...
        <Popover.Group className="hidden lg:flex space-x-12">
          <NavLink
            to="#"
            className="-mx-3 no-underline block rounded-lg px-3 py-2 text-base  leading-7 text-gray-900 hover:bg-gray-50"
          >
            Home
          </NavLink>
          <NavLink
          ...
          <Popover className="relative">
            <Popover.Button className="flex items-center gap-x-1 text-base leading-10 mt-[2px] text-gray-900">
              Service
              <ChevronDownIcon
                      ...
                      <Disclosure.Panel className="mt-2 space-y-2">
                        {[...products, ...callsToAction].map((item) => (
                          <Disclosure.Button
                            ...
                            as="a"
                            href={item.href}
                            className="block rounded-lg py-2 pl-6 pr-3 text-sm no-underline leading-7 text-gray-900 hover:bg-gray-50"
                          >
                            - {item.name}
                          </Disclosure.Button>
                        ))}
